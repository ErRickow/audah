...
async def bikin_ubot(_, callback_query):
    ...
    try:
        ...
        return await ubot.send_message(user_id, "Waktu Telah Habis")
    if await is_cancel(callback_query, api_id_msg.text):
        return
    try:
        api_id = int(api_id_msg.text)
    except ValueError:
        return await ubot.send_message(user_id, "API ID Haruslah berupa angka.")
    await callback_query.message.delete()
    ...
    get_otp = await ubot.send_message(user_id, "<b>Mengirim Kode OTP...</b>")
    await new_client.connect()
    try:
        code = await new_client.send_code(phone_number.strip())
    except FloodWait as FW:
        await get_otp.delete()
        return await ubot.send_message(user_id, FW)
    except ApiIdInvalid as AII:
        await get_otp.delete()
        return await ubot.send_message(user_id, AII)
    except PhoneNumberInvalid as PNI:
        await get_otp.delete()
        return await ubot.send_message(user_id, PNI)
    except PhoneNumberFlood as PNF:
        await get_otp.delete()
        return await ubot.send_message(user_id, PNF)
    except PhoneNumberBanned as PNB:
        await get_otp.delete()
        return await ubot.send_message(user_id, PNB)
    except PhoneNumberUnoccupied as PNU:
        await get_otp.delete()
        return await ubot.send_message(user_id, PNU)
    except Exception as error:
        await get_otp.delete()
        return await ubot.send_message(user_id, f"<b>ERROR:</b> {error}")
    try:
        await get_otp.delete()
        otp = await bot.ask(
            user_id,
    ...
    try:
        ...
        return await ubot.send_message(user_id, PCI)
    except PhoneCodeExpired as PCE:
        return await ubot.send_message(user_id, PCE)
        ...
        try:
            ...
            return await ubot.send_message(user_id, "Batas waktu tercapai 5 menit.")
    ...
    bot_msg = await ubot.send_message(
        user_id,
...
async def is_cancel(callback_query, text):
    if text.startswith("/cancel"):
        user_id = callback_query.from_user.id
        await ubot.send_message(user_id, "<b>Membatalkan Proses Pembuatan Userbot!</b>")
        return True
    return False
