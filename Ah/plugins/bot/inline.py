...
async def ping_function(message: Message, answers):
    ...
    answers.append(
        InlineQueryResultArticle(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("Support", url="xnxx.com")]]
            ),
        )
    )
    return answers
...
async def karman_function(message: Message, answers):
    ...
    answers.append(
        InlineQueryResultArticle(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="💢sᴜᴘᴘᴏʀᴛ💢", url="t.me/pamerdong"), InlineKeyboardButton(text="💢ᴏᴡɴᴇʀ💢", url="t.me/chakszzz")], [InlineKeyboardButton(text="💢ᴍᴇɴᴜ💢", callback_data="reopen")]]
            ),
        )
    )
    return answers
